...
Процедура ОбработатьДанные_ЗаполнитьВидДокумента(НаборЗаписей, СоответствиеВидовДокументов, Записать)
	...
	Для Каждого СтрокаТаблицы Из Таблица Цикл
		Если ТипЗнч(СтрокаТаблицы.ВидЭД) = Тип("ПеречислениеСсылка.ТипыДокументовЭДО") Тогда
			...
			КонецЕсли;
			Если СтрокаТаблицы.ВидЭД = Перечисления.ТипыДокументовЭДО.УдалитьПроизвольный Тогда
				ОбработатьДанные_ДобавитьНовыеВидыДокументов(Таблица, ТаблицаНовых,
					ЭлектронныеДокументыЭДО.ВидыДокументовДляПроизвольногоФормата(), СтрокаТаблицы, СтрокиДляУдаления);
			КонецЕсли;
			Если СтрокаТаблицы.ВидЭД = Перечисления.ТипыДокументовЭДО.Прикладной Тогда
				ОбработатьДанные_ДобавитьНовыеВидыДокументов(Таблица, ТаблицаНовых,
					ЭлектронныеДокументыЭДО.ПрикладныеВидыДокументов(), СтрокаТаблицы, СтрокиДляУдаления);
			КонецЕсли;
			Записать = Истина;
		КонецЕсли;
	КонецЦикла;
