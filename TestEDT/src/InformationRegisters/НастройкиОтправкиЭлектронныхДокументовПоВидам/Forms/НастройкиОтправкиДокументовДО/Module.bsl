...
Процедура ОткрытьФормуВыбораУчетныхЗаписей()
	...
	ПараметрыВыбора = НастройкиОтправкиЭДОСлужебныйКлиент.НовыеПараметрыТранстпортныхНастроек();
...
Процедура УстановитьТекущуюСтроку(Форма)
	...
	Если ТекущаяСтрока = Неопределено
		...
		Форма.Элементы.ИсходящиеДокументыДО.ТекущаяСтрока = Форма.ИсходящиеДокументыДО[1].ПолучитьИдентификатор();
	КонецЕсли;
