...
Процедура НастройкиМаршрутПодписанияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = МожноВыбиратьМаршрут(ДанныеСтроки.ВидПодписи, ВыбраннаяСтрока);
	НастройкиВнутреннегоЭДОСлужебныйКлиентСервер.УстановитьСвойстваПоляМаршрутПодписанияДляВнутреннегоЭДО(
		Элемент, ДанныеСтроки.ВидПодписи, Организация, Истина);
...
Процедура НастройкиФормироватьПриИзменении(Элемент)
	...
	Если ТекущиеДанные.Формировать = 1
		И Не ЗначениеЗаполнено(ТекущиеДанные.ВидПодписи) Тогда
