...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьДанные(КлючПриглашения, ИдентификаторОрганизации);
	НастроитьФорму();
...
&НаСервере
Процедура ЗаполнитьДанные(КлючПриглашения, ИдентификаторОрганизации)
...
&НаКлиенте
Процедура ПослеИнтерактивногоСозданияКонтрагента(НовыйКонтрагент, ДополнительныеПарметры) Экспорт
