...
Процедура ПослеПолученияДоступныхСертификатов(Результат, Контекст) Экспорт
	...
	Сертификаты = ВсеСертификатыИСамыйНовый(Контекст.СписокСертификатов, Результат);
...
&НаСервереБезКонтекста
Функция ВсеСертификатыИСамыйНовый(Знач СписокСертификатов, ДоступныеСертификаты)
