...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ТипПроцесса.Ширина = 7;
	Элементы.ТипПроцесса.РастягиватьПоГоризонтали = Ложь;
	Элементы.Переместить(Элементы.ТипПроцесса, Элементы.Список, Элементы.Ссылка);
