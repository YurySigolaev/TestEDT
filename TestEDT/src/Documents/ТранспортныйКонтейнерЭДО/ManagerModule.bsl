...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ ПЕРВЫЕ 1000
	|	ТранспортныйКонтейнерЭДОУдалитьЭлектронныеДокументы.Ссылка КАК Ссылка
	|ИЗ
	|	Документ.ТранспортныйКонтейнерЭДО.УдалитьЭлектронныеДокументы КАК ТранспортныйКонтейнерЭДОУдалитьЭлектронныеДокументы
	|ГДЕ
	|	ТранспортныйКонтейнерЭДОУдалитьЭлектронныеДокументы.Ссылка > &Ссылка
