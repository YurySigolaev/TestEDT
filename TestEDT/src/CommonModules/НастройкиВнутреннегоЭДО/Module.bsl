...
//
// Параметры:
//	Использовать - Булево - новое значение фунциональной опции.
//
Процедура УстановитьПризнакИспользованияВнутреннегоЭДО(Использовать) Экспорт
	...
	Если Использовать И Не ИнтеграцияЭДО.РазрешеноИспользоватьВнутреннийЭДО() Тогда
		ТекстОшибки = НСтр("ru = 'Изменение состояния функциоанльной опции использования внутренних документов запрещено прикладным решением.'");
...
#Область ВключитьИспользованиеВнутреннихДокументовНачальноеЗаполнение
	...
	НоваяСтрока.Процедура = "РегистрыСведений.НастройкиВнутреннегоЭДО.ВключитьИспользованиеВнутреннихДокументов";
...
#Область ВключитьИспользованиеВнутреннихДокументов
	...
	НоваяСтрока = Обработчик.ПриоритетыВыполнения.Добавить();
	НоваяСтрока.Процедура = "РегистрыСведений.НастройкиВнутреннегоЭДО.ВключитьИспользованиеВнутреннихДокументовНачальноеЗаполнение";
