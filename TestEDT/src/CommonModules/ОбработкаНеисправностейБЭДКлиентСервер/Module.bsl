...
// Возвращаемое значение:
//  Структура:
//    * Идентификатор     - Строка - идентификатор вида ошибки формата "ИмяПодсистемы.НаименованиеОшибки",
//                      пример: "ОбменСКонтрагентами.СертификатПросрочен". Ошибки с одинаковыми
