...
// ОбработчикПродолжения - ОписаниеОповещения - обработчик оповещения, который нужно вызвать для продолжения
//                         процесса формирования электронных документов. В качестве результата в обработчик
//                         необходимо передать массив учетных документов для формирования электронных.
// СтандартнаяОбработка - Булево - в случае установки Истина дальнейшее формирование электронных документов
//                        блокируется и ожидает вызова обработчика, заданного в параметре ОбработчикПродолжения
Процедура ПередФормированиемЭлектронныхДокументов(ОбъектыУчета, ОбработчикПродолжения, СтандартнаяОбработка = Истина) Экспорт
...
// ОбработчикПродолжения - ОписаниеОповещения - обработчик оповещения, который нужно вызывать для продолжения
//                         процесса формирования электронных документов. В качестве результата в обработчик
//                         необходимо передать массив электронных документов для утверждения.
// СтандартнаяОбработка - Булево - в случае установки Истина дальнейшее формирование электронных документов
//                        блокируется и ожидает вызова обработчика, заданного в параметре ОбработчикПродолжения
Процедура ПередУтверждениемЭлектронныхДокументов(ЭлектронныеДокументы, ОбработчикПродолжения, СтандартнаяОбработка = Истина) Экспорт
