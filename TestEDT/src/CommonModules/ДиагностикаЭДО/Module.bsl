...
Процедура ДобавитьТранспортныйКонтейнерВФайлыДляТехподдержки(ТранспортныйКонтейнер, ФайлыДляТехподдержки) 
	...
	Если ТранспортныйКонтейнер = Тип("ДокументСсылка.ТранспортныйКонтейнерЭДО") Тогда
		ПрисоединенныеФайлыМассив = ТранспортныеКонтейнерыЭДО.ПрисоединенныеФайлыКонтейнеров(
		ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ТранспортныйКонтейнер));
		ПрисоединенныеФайлыКонтейнера = ПрисоединенныеФайлыМассив[ТранспортныйКонтейнер];
...
Процедура ДобавитьФайлВФайлыДляТехподдержки(ДвоичныеДанные, ФайлыДляТехподдержки)
	...
	ОписаниеФайла.ИмяФайла = ОбщегоНазначенияКлиентСервер.НайтиНедопустимыеСимволыВИмениФайла(ИмяФайла);
