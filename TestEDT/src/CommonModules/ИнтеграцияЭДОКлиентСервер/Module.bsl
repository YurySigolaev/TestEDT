...
// Возвращает ссылку на объект учета.
// Можно использовать для записи в базу данных или ключа поиска в коллекциях.
//
// Параметры:
//  ОбъектУчета - см. ИнтеграцияЭДОКлиентСервер.НовыйОбъектУчета
//
// Возвращаемое значение:
//  ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - ссылка на объект учета.
//
Функция СсылкаНаОбъектУчета(Знач ОбъектУчета) Экспорт
	
	Возврат ОбъектУчета.Ссылка;
...
// Возвращает готовые к документообороту объекты, согласно выполненной проверке.
//
// Параметры:
//  Проверка - см. ИнтеграцияЭДО.НоваяПроверкаГотовностиКДокументообороту
//
// Возвращаемое значение:
//  ФиксированныйМассив - готовые объекты.
//
Функция ГотовыеКДокументооборотуОбъекты(Знач Проверка) Экспорт

	Возврат Проверка.Готовые;

КонецФункции

// Возвращает неготовые к документообороту объекты, согласно выполненной проверке.
//
// Параметры:
//  Проверка - см. ИнтеграцияЭДО.НоваяПроверкаГотовностиКДокументообороту
//
// Возвращаемое значение:
//  ФиксированныйМассив - неготовые объекты.
//
Функция НеготовыеКДокументооборотуОбъекты(Знач Проверка) Экспорт

	Возврат Проверка.Неготовые;
...
Функция ВидОшибкиДокументНеактуаленТребуетсяАннулирование() Экспорт
