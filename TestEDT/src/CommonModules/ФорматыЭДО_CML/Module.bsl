...
Функция ПрочитатьДокумент(Знач Формат) Экспорт
...
Процедура ПрочитатьДанныеПоТоваруКаталога(НаборДанных, ЭД, ДанныеРазбора, НовыйЭД, Ошибка, ИдентификацияПоНоменклатуреКомпании = Истина) Экспорт
...
Процедура ПрочитатьАктНаПередачуПравXDTO(ЭД, ДанныеРазбора, НовыйЭД, Ошибка) Экспорт
	...
	ДеревоЭлектронногоДокументаБЭД.ДобавитьРеквизитШапкиОбъекта(НовыйЭД, "ДатаФормирования",
		РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ЭД, "ДатаФормирования", , "Дата"));
...
Процедура ПрочитатьДанныеКонтрагентаCML(Элемент, ЭД, ДанныеРазбора, НовыйЭД, Ошибка, Роль = "", ДопПараметры = Неопределено) Экспорт
...
Процедура ПрочитатьСтрокуТоваровCML(ТоварXDTO, НовыйЭД, СписокТЧ, ПоляПоискаТовара, ДанныеРазбора, Ошибка) Экспорт
	...
	Если Не ЗначениеЗаполнено(ИдТовара) Тогда
		...
		ИдТовара = СопоставлениеНоменклатурыКонтрагентов.ИдентификаторТовараПоСтроке(ВРег(СтрЗаменить(НаименованиеТовара, " ", ""))
...
//
Процедура ДанныеСпискаЗначенийCML(ОбъектXDTO, НовыйЭД, Ошибка) Экспорт
