...
Процедура ПодготовитьКДокументообороту(НаборОбъектовУчета, ОбработкаЗавершения) Экспорт		
	...
	ОбработчикПродолжения = Новый ОписаниеОповещения("ПодготовитьКДокументооборотуПослеПроверкиПроведения", ЭтотОбъект,
		ДополнительныеПараметры);
	ОбщегоНазначенияБЭДКлиент.ВыполнитьПроверкуПроведенияДокументов(НаборОбъектовУчета, ОбработчикПродолжения);
...
Процедура ПодготовитьКДокументооборотуПослеПроверкиПроведения(НаборОбъектовУчета, ДополнительныеПараметры) Экспорт
	
	Если ЗначениеЗаполнено(НаборОбъектовУчета) Тогда
		СтандартнаяОбработка = Истина;
		ОбработкаПродолжения = Новый ОписаниеОповещения("ПодготовитьКДокументооборотуЗавершение", ЭтотОбъект, ДополнительныеПараметры);
		
		ОбменСКонтрагентамиКлиентПереопределяемый.ПередФормированиемЭлектронныхДокументов(НаборОбъектовУчета,
			ОбработкаПродолжения, СтандартнаяОбработка);
			
		Если СтандартнаяОбработка Тогда
			ПодготовитьКДокументооборотуЗавершение(НаборОбъектовУчета, ДополнительныеПараметры);
		КонецЕсли;
	Иначе
		ПодготовитьКДокументооборотуЗавершение(НаборОбъектовУчета, ДополнительныеПараметры);		
	КонецЕсли;
...
Процедура ПодготовитьКДокументооборотуЗавершение(НаборОбъектовУчета, ДополнительныеПараметры) Экспорт
	
	ОбработкаЗавершения = ДополнительныеПараметры.ОбработкаЗавершения;
	ВыполнитьОбработкуОповещения(ОбработкаЗавершения, НаборОбъектовУчета);
