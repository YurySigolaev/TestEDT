...
// Подключает / отключает оповещение о наличи новых электронных документов к получению.
//
// Параметры:
...
Функция НовыйПроизвольныйДокумент(ПараметрыФормирования, ПараметрыФайла) Экспорт
	...
	Возврат ОбменСКонтрагентамиВызовСервера.НовыйПроизвольныйДокумент(ПараметрыФормирования, ПараметрыФайла);
