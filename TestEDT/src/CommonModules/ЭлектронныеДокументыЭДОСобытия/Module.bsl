...
// 
// Параметры:
// 	ВидСообщения - СправочникСсылка.ВидыДокументовЭДО - ссылка на вид электронного документа.
...
// Параметры:
// 	ЭлектронныйДокумент - ДокументСсылка.ЭлектронныйДокументИсходящийЭДО - ссылка исходящего документа.
// 	СостояниеЭДО - ПеречислениеСсылка.СостоянияДокументовЭДО - состояние исходящего электронного документа.
// 	КонтекстДиагностики - См. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики.
...
Процедура ПослеЗагрузкиНовыхЭлектронныхДокументов(ЗагруженныеДокументы, КонтекстСобытия, КонтекстДиагностики) Экспорт
	ИнтеграцияЭДО.ПослеЗагрузкиНовыхЭлектронныхДокументов(ЗагруженныеДокументы, КонтекстСобытия, КонтекстДиагностики);
КонецПроцедуры
...
// 	  * ТипЭлементаРегламента - ПеречислениеСсылка.ТипыЭлементовРегламентаЭДО - тип элекмента регламентв;
