...
// 
// Параметры:
// 	НаборОбъектовУчета - Массив - массив объектов учета, по которым формируются электроные документы.
// Возвращаемое значение:
...
// * ДвоичныеДанныеПредставления - ДвоичныеДанные - данные визулизации (табличного документа). 
...
// обращения к объекам метаданных библиотеки.
// 
// Возвращаемое значение:
...
// к строковым идентфикаторам форматов.
//
// Возвращаемое значение:
//  Структура - форматы:
...
// Формирует данные элекронного документа в виде дерева.
// 
// Параметры:
...
Процедура ЗагрузитьДокументИзФайла(ДанныеФайла, ОбъектыУчета, Отказ) Экспорт
	...
	ЗаполнитьЗначенияСвойств(ПараметрыОтраженияВУчете, ДанныеФайла);
	Если ДанныеФайла.ДанныеОсновногоФайла <> Неопределено Тогда
		ПараметрыОтраженияВУчете.ДанныеОсновногоФайла = РаботаСФайламиБЭД.НовоеОписаниеФайла();
		ПараметрыОтраженияВУчете.ДанныеОсновногоФайла.ДвоичныеДанные = ДанныеФайла.ДанныеОсновногоФайла;
	КонецЕсли;
	
	Если ДанныеФайла.ДанныеДополнительногоФайла <> Неопределено Тогда
		ПараметрыОтраженияВУчете.ДанныеДополнительногоФайла = РаботаСФайламиБЭД.НовоеОписаниеФайла();
		ПараметрыОтраженияВУчете.ДанныеДополнительногоФайла.ДвоичныеДанные = ДанныеФайла.ДанныеДополнительногоФайла;
	КонецЕсли;
	
	ОбменСКонтрагентамиИнтеграция.ОтразитьВУчетеЭлектронныйДокумент(ПараметрыОтраженияВУчете, ОбъектыУчета, Отказ);
...
// Возвращаемое значение:
// 	Булево - Истина, если документооборот по переданому объекту учета или параметрам полностью настроен.
