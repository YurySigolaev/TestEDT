...
// Возвращает результат успеха создания приглшашения со статусом "Требуется отправка",
...
Функция ВидОшибкиАвтоматическоеСозданиеКонтрагентаНевозможно() Экспорт
...
//
Функция ОбработатьТаблицуПриглашений(ТаблицаПриглашений, КонтекстДиагностики, Сохранить = Истина) Экспорт
	...
	Для Каждого НовыеПриглашения Из ТЗПоследнихИзменений Цикл
		...
		Попытка
			...
			Если ЗначениеЗаполнено(ИдентификаторКонтрагента) И Не ЗначениеЗаполнено(МенеджерЗаписи.ИдентификаторКонтрагента) Тогда
