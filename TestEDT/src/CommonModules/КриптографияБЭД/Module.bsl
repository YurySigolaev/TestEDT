...
Функция Расшифровать(Данные, Пароль, КонтекстДиагностики, Программа = Неопределено) Экспорт
	...
	ОписаниеОшибки = "";
	МенеджерКриптографии = ЭлектроннаяПодпись.МенеджерКриптографии(ВидОперации, Истина, ОписаниеОшибки, Программа);
...
Функция Подписать(ОписаниеДанных, КонтекстДиагностики, ПаролиСертификатов = Неопределено, МенеджерКриптографии = Неопределено) Экспорт
	...
	Если МенеджерКриптографии = Неопределено Тогда
		МенеджерКриптографии = ЭлектроннаяПодпись.МенеджерКриптографии(Операция, Ложь, ОписаниеОшибки,
...
Функция ПроверитьПодпись(МенеджерКриптографии, ИсходныеДанные, Подпись, КонтекстДиагностики) Экспорт
	...
	РезультатПроверкиПодписи = ЭлектроннаяПодпись.ПроверитьПодпись(
				МенеджерКриптографии, ИсходныеДанные, Подпись, ТекстОшибки);
	РезультатПроверки.ДатаПроверкиПодписи = ТекущаяУниверсальнаяДата();
	РезультатПроверки.ПодписьВерна = РезультатПроверкиПодписи.ПодписьВерна;
	РезультатПроверки.СертификатДействителен = РезультатПроверкиПодписи.СертификатДействителен;
	РезультатПроверки.ТекстОшибкиПроверкиПодписи = РезультатПроверкиПодписи.ТекстОшибкиПроверкиПодписи;
	РезультатПроверки.ТекстОшибкиПроверкиСертификата = РезультатПроверкиПодписи.ТекстОшибкиПроверкиСертификата;
...
Функция НовыйОтборУстановленныхПодписей() Экспорт
