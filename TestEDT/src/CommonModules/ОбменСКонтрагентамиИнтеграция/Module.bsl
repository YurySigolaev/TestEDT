...
// Возвращает данные пакета элетронного документа.
// 
// Параметры:
...
//   * Содержание - См. _ЭлектронныеДокументыЭДО.РаспознатьДокументПоДвоичнымДанным - содержание документа.
...
Функция СформироватьДанныеДляВыгрузки(ОписанияОбъектовУчета, ПараметрыВизуализацииОбъектовУчета = Неопределено) Экспорт
	...
	НаборДанныхДокументов = ЭлектронныеДокументыЭДО.СформироватьДанныеДокументовДляВыгрузки(ОписанияОбъектовУчета);
...
Функция СоответствиеВидовЭДВидамДокументовЭДО() Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		ТипДокументаПоНовойАрхитекртуре = ЭлектронныеДокументыЭДО.Обновление_ТипДокументаПоНовойАрхитекртуре(
		ВыборкаДетальныеЗаписи.Ссылка);
		ТипДокументаУстарел = ТипДокументаПоНовойАрхитекртуре <> ВыборкаДетальныеЗаписи.Ссылка;
		Если ТипДокументаУстарел Тогда
			УстаревшиеТипыДокументов.Добавить(ВыборкаДетальныеЗаписи.Ссылка);
		КонецЕсли;
		Если ЭлектронныеДокументыЭДО.ЭтоСтандартныйТипДокумента(ТипДокументаПоНовойАрхитекртуре)
			Или ЭлектронныеДокументыЭДО.ЭтоТипДокументаСлужебный(ТипДокументаПоНовойАрхитекртуре)
			Или ТипыДокументовПроизвольногоФормата.Найти(ТипДокументаПоНовойАрхитекртуре) <> Неопределено
			Или ТипДокументаПоНовойАрхитекртуре = Перечисления.ТипыДокументовЭДО.РеквизитыОрганизации Тогда
			ВсеТипыДокументов.Добавить(ТипДокументаПоНовойАрхитекртуре);
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого ТипДокумента Из УстаревшиеТипыДокументов Цикл
		Если ВидыДокументовПоТипам[ТипДокумента] = Неопределено Тогда
			НовыйТипДокумента = ЭлектронныеДокументыЭДО.Обновление_ТипДокументаПоНовойАрхитекртуре(ТипДокумента);
