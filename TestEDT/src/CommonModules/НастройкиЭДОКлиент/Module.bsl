...
// См. НастройкиОтправкиЭДОКлиент.НовыеПараметрыТранстпортныхНастроек
Функция НовыеПараметрыТранстпортныхНастроек() Экспорт
	
	Возврат НастройкиОтправкиЭДОКлиент.НовыеПараметрыТранстпортныхНастроек();
