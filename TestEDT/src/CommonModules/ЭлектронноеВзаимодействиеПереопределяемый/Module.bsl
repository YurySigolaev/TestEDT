...
//  Сведения - см. ОбщегоНазначенияБЭД.ДанныеЮрФизЛица
//
...
//
// Параметры:
//  СведенияОрганизации - См. ПолучитьДанныеЮрФизЛица - сведения об организации, по которой надо составить описание. 
