...
Процедура ВывестиЭДНаПросмотр(СтрокаДанных)
	...
	Если ЗначениеЗаполнено(СтруктураПараметров.Документооборот) Тогда
		ИнтерфейсДокументовЭДОКлиент.ОткрытьЭлектронныйДокумент(СтрокаДанных.Документооборот, Истина);
	Иначе
