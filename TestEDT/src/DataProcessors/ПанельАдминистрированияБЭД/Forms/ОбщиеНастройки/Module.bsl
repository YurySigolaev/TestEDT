...
Процедура НастроитьПоддержкаЭДО(Команда)
	...
	НастроитьРасписаниеРегламентногоЗадания(ИмяРегламентногоЗаданияПоддержкаЭДО());
...
Процедура УстановитьНастройкиЗаданий()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		...
		ИмяЗадания = ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияПоддержкаЭДО();
		УстановитьНастройкуЗадания(ИмяЗадания, Элементы.ПоддержкаЭДО,
			ИспользоватьАвтоматическуюПоддержкуЭДО, ЭтоАдминистраторСистемы);
...
&НаКлиенте
Функция ИмяРегламентногоЗаданияПоддержкаЭДО()
	
	Возврат ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияПоддержкаЭДО();
